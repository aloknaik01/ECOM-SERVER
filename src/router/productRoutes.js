...
router.post("/admin/create", isAuthenticated, isVendorOrAdmin, createProduct);
router.put("/admin/update/:id", isAuthenticated, isVendorOrAdmin, updateProduct);
router.delete("/admin/delete/:id", isAuthenticated, isVendorOrAdmin, deleteProduct);
router.get("/admin/all", isAuthenticated, isVendorOrAdmin, getAllProductsAdmin);
